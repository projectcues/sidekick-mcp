-- 1. Delete existing 1536-dimensional data to prevent cast errors
delete from public.document_chunks;

-- 2. Drop the existing HNSW index
drop index if exists public.document_chunks_embedding_idx;

-- 3. Alter the embedding column from 1536 to 384 dimensions
...
-- 5. Update the match_document_chunks function to accept vector(384)
